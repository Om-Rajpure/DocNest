...
export default function LoginPage() {
  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-deco" style={{ background: 'linear-gradient(145deg, #1E40AF 0%, #0369A1 50%, #0E7490 100%)' }}>
        ...
        <div className="auth-deco-content">
          ...
          <h2>Your Documents, Perfectly Organized.</h2>
          <p>Manage client records, identity documents, and family relationships in one secure platform.</p>
          <div className="auth-deco-pills">
            <span className="auth-deco-pill">🔒 Secure</span>
            <span className="auth-deco-pill">⚡ Fast</span>
            <span className="auth-deco-pill">🇮🇳 India Ready</span>
          </div>
        </div>
      </div>
      ...
      <div className="auth-form-panel">
        ...
        >
          ...
          <h1>Welcome back</h1>
          <p className="auth-subtitle">Sign in to your DocNest account</p>
